...
* @details  <br>
    <B>General</B><br>
    You will use Pololu Zumo Shields for your robot project with CY8CKIT-059(PSoC 5LP) from Cypress semiconductor. 
    This library has basic methods of Accelerometer, Ambient Light Sensor, Gyroscope, IR receiver, Magnetometer, Motors, Wii nunchuck, Reflectance Sensor, Ultra Sonic Sensor and I2C communication.<br>
